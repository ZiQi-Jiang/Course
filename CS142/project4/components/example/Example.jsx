  ...
  render() {
    return (
      <div className="container Example">
        ...
        {
         `My name is ${this.state.name}, and my motto is ${this.state.motto}`
        }
        <br></br>
        Change Motto:
        <input value={this.state.motto} onChange={(event)=>{console.log(this);this.setState({motto:event.target.value})}}></input>
