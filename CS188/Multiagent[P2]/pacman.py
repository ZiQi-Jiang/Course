...
"""
Pacman.py holds the Logic[P3] for the classic pacman game along with the main
code to run a game.  This file is divided into three sections:
  ...
  (ii)  The hidden secrets of pacman:
          This section contains all of the Logic[P3] code that the pacman
...
#        GameState.explored.add(self)
    ...
    def generateSuccessor(self, agentIndex, action):
        ...
        # Let agent's Logic[P3] deal with its action's effects on the board
        if agentIndex == 0:  # Pacman is moving
